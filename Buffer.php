...
class Buffer
{
    ...
    public function add(array $numbersArray): array
    {
        array_push($this->container, ...$numbersArray);

        while (sizeof($this->container) >= 5) {
            var_dump(array_sum(array_splice($this->container, 0, 5)));
        }
